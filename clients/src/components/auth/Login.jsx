                        ...
                        <div className="w-72">
                            ...
                            <form method='post' className="mt-4" onSubmit={login} >
                                ...
                                <div className="mb-3">
                                    ...
                                    <input type="text" name='username' value={username} onChange={onChangeLoginForm} placeholder="Enter your email" className="block w-full rounded-md border border-gray-300 focus:border-purple-700 focus:outline-none focus:ring-1 focus:ring-purple-700 py-1 px-1.5 text-gray-500" />
                                </div>

                                <div className="mb-3">
                                    <label className="mb-2 block text-xs font-semibold">Password</label>
                                    <input type="password" name='password' value={password} onChange={onChangeLoginForm} placeholder="*****" className="block w-full rounded-md border border-gray-300 focus:border-purple-700 focus:outline-none focus:ring-1 focus:ring-purple-700 py-1 px-1.5 text-gray-500" />
                                </div>
                            ...
                            <div className="text-center">
                                ...
                                <a href="/register" className="text-xs font-semibold text-purple-700 ml-2">Sign up</a>
                            </div>
                        </div>
                    </div>
