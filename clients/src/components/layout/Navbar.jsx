            ...
            <div className="w-full flex items-center justify-between mt-0 px-6 py-2">
                ...
                <div className="hidden md:flex md:items-center md:w-auto w-full order-3 md:order-1" id="menu">
                    <nav>
                        <ul className="md:flex items-center justify-between text-base text-blue-600 pt-4 md:pt-0">
                            ...
                            <li><a className="inline-block no-underline hover:text-black font-medium text-lg py-2 px-4 lg:-ml-2" href="/dashboard">Dashboard</a></li>
                            <li><a className="inline-block no-underline hover:text-black font-medium text-lg py-2 px-4 lg:-ml-2" href="/users">User</a></li>
                ...
                <div className="order-2 md:order-3 flex flex-wrap items-center justify-end mr-0 md:mr-4" id="nav-content">
                    <div className="auth flex items-center w-full md:w-full">
                        <p>Hello {username} </p>
                        <button onClick={logout} className="ml-2 bg-red-400 text-gray-200  p-2 rounded  hover:bg-red-300 hover:text-gray-100">Log out</button>
                        {/* <>
