    ...
    return (
        <div>
            <div className="w-full max-w-4xl flex flex-col sm:flex-row justify-between rounded-sm shadow bg-white">
                ...
                <div className="flex">
                    {/* :::icon */}
                    <div className="p-3 inline-flex justify-end items-center bg-green-500">
                    ...
                    {/* :::content */}
                    <div className="px-5 flex-grow inline-flex items-center bg-green-500 sm:bg-transparent">
                        <p className="text-sm text-white sm:text-gray-700 font-semibold">Congratulations! You did it right.</p>
                    </div>
                </div>
                {/* ::Actions Container */}
                <div className="flex-grow-0 p-3 pr-6 inline-flex justify-center sm:justify-start items-center space-x-4">
                    {/* :::details */}
                    <a href="#link" className="text-xs text-gray-700 font-semibold underline hover:text-green-600">Details</a>
                    {/* :::dismiss button */}
                    <button type="button" className="group inline-flex justify-center items-center">
                        <svg className="w-5 h-5 text-green-600 group-hover:text-black fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
